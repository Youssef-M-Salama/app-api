...
namespace App.Api.Controllers.V1
{
    ...
    public class AdminController : CustomControllerBase
    {
        ...
        /// </summary>
        /// <remarks>
        /// Returns a single flat object with the following field groups:
        ///
        /// **Pending / Active (original fields)**
        /// - PendingVerifications  — charities + donors awaiting approval (Pending or InReview)
        /// - PendingCharityNeeds   — charity needs awaiting admin approval
        /// - PendingOffers         — donor offers awaiting admin approval
        /// - TotalUsers            — all confirmed, non-rejected, non-admin users
        /// - ActiveCharityNeeds    — charity needs with status Approved
        /// - ActiveOffers          — offers with status Approved
        ///
        /// **Users**
        /// - ActiveUsers           — users whose IsActive == true
        /// - SuspendedUsers        — users whose IsActive == false
        /// - TotalCharities        — charities with VerificationState == Verified
        /// - TotalDonors           — donor organisations with VerificationState == Verified
        ///
        /// **Verifications**
        /// - TotalVerified              — total verified charities + donors
        /// - TotalRejectedVerifications — total rejected charities + donors
        ///
        /// **Charity Needs**
        /// - RejectedCharityNeeds  — charity needs with status Rejected
        /// - FulfilledCharityNeeds — charity needs with status Fulfilled
        ///
        /// **Offers**
        /// - RejectedOffers  — offers with status Rejected
        /// - FulfilledOffers — offers with status Fulfilled
        /// - ExpiredOffers   — offers with status Expired
        ///
        /// **Applications**
        /// - TotalNeedApplications      — all NeedApplications ever submitted
        /// - FulfilledNeedApplications  — NeedApplications with status Fulfilled
        /// - TotalOfferApplications     — all OfferApplications ever submitted
        /// - FulfilledOfferApplications — OfferApplications with status Fulfilled
        /// </remarks>
